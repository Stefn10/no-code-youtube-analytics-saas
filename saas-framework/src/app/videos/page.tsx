...
import { GenerateThumbnailModal } from '@/components/generate-thumbnail-modal';
...
export default function VideosPage() {
  ...
  const [selectedVideo, setSelectedVideo] = useState<AirtableRecord | null>(null);
  ...
  const handleGenerateThumbnailAssets = () => {
    // This function is now deprecated - thumbnails are generated by clicking on them
    console.log('Thumbnail generation is now done by clicking on thumbnails');
  };

  const handleThumbnailClick = (video: AirtableRecord) => {
        ...
        return (
          <div className="flex justify-center">
            <div 
              ...
              onClick={() => {
                const video = recordId ? data?.records.find(r => r.id === recordId) || null : null;
                if (video) {
            ...
            >
              <img 
                src={thumbnailUrl} 
                alt="Video thumbnail" 
                className="w-32 h-20 object-cover rounded-md shadow-sm border transition-all duration-200 group-hover:border-yellow-400 group-hover:border-2 group-hover:shadow-lg"
                loading="lazy"
              ...
              />
              <div className="absolute inset-0 bg-yellow-400/20 opacity-0 group-hover:opacity-100 transition-opacity duration-200 rounded-md flex items-center justify-center">
                ...
                <>
                  ...
                  <div className="flex flex-wrap gap-2 justify-end mb-4">
                    ...
                    <Button
                      ...
                      className="flex items-center gap-2"
                      disabled={true}
                      title="Click on thumbnails to generate new ones"
                    >
